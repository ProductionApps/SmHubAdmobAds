...
public class AppOpenAdManager implements Application.ActivityLifecycleCallbacks,
    ...
    public void onActivityStarted(@NonNull Activity activity) {
        ...
        if (!isShowingAd && activity!=null) {
//            BaseApplication.getInstance().currentActivity = activity;
...
//                            Toast.makeText(context, "onAdFailedToLoad", Toast.LENGTH_SHORT).show();
    ...
    private void showAdIfAvailable(@NonNull final Activity activity) {
        showAdIfAvailable(activity,
                new BaseApplication.OnShowAdCompleteListener() {
                    @Override
    ...
    public void showAdIfAvailable(
            ...
            @NonNull BaseApplication.OnShowAdCompleteListener onShowAdCompleteListener) {

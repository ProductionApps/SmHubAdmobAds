...
public class AdmobAdController{
    ...
    AdView adView;
    public void showBanner(CustomActivity context, ViewGroup frameLayout, AdSize adSize,String id,FallbackListener fallbackListener){
        loadBanner(context,frameLayout,adSize,id,fallbackListener);
    }

    public void loadCacheBanner(CustomActivity context,AdSize adSize,String id,FallbackListener fallbackListener){
        if (adRequest==null)
            adRequest = new AdRequest.Builder().build();
...
//    }
    ...
    void loadBanner(CustomActivity context, ViewGroup frameLayout, AdSize adSize,String id,FallbackListener fallbackListener){
        if (adRequest==null)
            adRequest = new AdRequest.Builder().build();
        if (frameLayout!=null){
            AdView adView = new AdView(context);
    ...
    public void getNativeAd(CustomActivity context,String id,FallbackListener fallbackListener){
    ...
    public void showNativeAdCurrent(Context context, String id, View mainNativeViewHolder, FallbackListener fallbackListener)  {
     ...
     */
    public void showInterstitial (InterstitialListener interstitialListener, CustomActivity customActivity,String id,FallbackListener fallbackListener){

...
import com.smarthub.smhubads.ads.AdsType;
...
//        putAdsEvent("unity onInitializationComplete");
        AppLogger.d("onInitializationComplete");
        UnityMediationController.getInstance().loadInterstitial(AdsController.getInstance().adUnits.unityInterstitial);
        UnityMediationController.getInstance().loadRewarded(AdsController.getInstance().adUnits.unityReward);
    }

    @Override
    public void onInitializationFailed(UnityAds.UnityAdsInitializationError error, String message) {
        isUnityInitialized = false;
        putAdsEvent("unity failed:"+message);
...
//                            Toast.makeText(activity, "onAdShowedFullScreenContent", Toast.LENGTH_SHORT).show();
    ...
    public class MaxAppOpenManager implements LifecycleObserver, MaxAdListener {
        ...
        public MaxAppOpenManager(final Context context) {
            ProcessLifecycleOwner.get().getLifecycle().addObserver( this );

            this.context = context;

            appOpenAd = new MaxAppOpenAd( AdsController.getInstance().adUnits.maxAppOpen, context);
        ...
        public void showAdIfReady() {
            ...
            if ( appOpenAd.isReady() ) {
                appOpenAd.showAd(AdsController.getInstance().adUnits.maxAppOpen);
            }
            else {
                appOpenAd.loadAd();
            }
